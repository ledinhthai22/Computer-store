        ...
        <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 sticky top-24 transition-all">
            ...
            <div className="border-t border-dashed border-gray-200 pt-6">
                ...
                <button 
                    ...
                    className="w-full bg-[#2f9ea0] text-white text-sm py-2.5 rounded-md font-medium hover:bg-blue-600 active:scale-95 transition-all duration-200 shadow-sm hover:shadow"
                >
                    Áp dụng bộ lọc
                </button>
            </div>
