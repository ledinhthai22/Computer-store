      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden duration-200">
        ...
        <div className="bg-gray-50 p-4 flex justify-center gap-3">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg shadow-md transition-colors disabled:bg-amber-300 flex items-center gap-2 cursor-pointer"
          >
