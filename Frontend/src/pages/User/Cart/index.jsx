      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm p-4 flex flex-col">
              ...
              <div className="flex flex-col justify-between h-[550px]">
                <div className="space-y-3 overflow-y-auto">
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-sm text-red-600 hover:underline absolute right-3 top-1/2 -translate-y-1/2 opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition cursor-pointer"
                        >
                          Xoá
                        </button>
                      </div>
                  ...
                  {paginatedCart.length === 0 && currentPage > 1 && (
                ...
                <Link
                  ...
                  className={`block mt-5 w-full text-center py-2.5 rounded-xl font-medium transition cursor-pointer
                    ${selectedItems.length === 0
                      ...
                      : "bg-[#2f9ea0] text-white hover:bg-[#2aa8aa]"}`}
                >
                  Thanh toán
                </Link>
