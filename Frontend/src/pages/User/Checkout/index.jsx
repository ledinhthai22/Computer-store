...
export default function Checkout() {
  ...
  const checkoutItemsFromCart = cart.filter((item) => selectedIds.includes(item.id));

  const checkoutItems = checkoutItemsFromCart.length > 0 ? checkoutItemsFromCart : [
    { id: 1, title: "Áo thun nam cotton premium cao cấp", price: 299000, quantity: 2, thumbnail: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400" },
    { id: 2, title: "Quần jean nam slimfit", price: 450000, quantity: 1, thumbnail: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=400" },
  ];
  ...
  const handleSaveAddress = async () => {
    try {
      ...
      // Ưu tiên chọn địa chỉ mặc định mới nhất
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              {loadingAddresses ? (
                ...
                <div className="space-y-4">
                  {/* Dropdown chọn địa chỉ (nếu có nhiều hơn 1) */}
                  {addresses.length > 1 && (
                    <div>
                      <select
                  ...
                  <div key={item.id} className="flex gap-4 py-4 first:pt-0 last:pb-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600">
                        Số lượng: <span className="font-semibold text-gray-900">{item.quantity}</span>
                      </p>
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-200 p-6 sticky top-4">
              ...
              <div className="space-y-3 mb-5">
                <div className="flex justify-between text-gray-700">
                  <span>Tạm tính ({checkoutItems.length} sp)</span>
