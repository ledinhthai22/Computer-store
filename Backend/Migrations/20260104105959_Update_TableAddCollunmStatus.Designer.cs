...
namespace Ecommerce.Migrations
{
    ...
    [Migration("20260104105959_Update_TableAddCollunmStatus")]
    partial class Update_TableAddCollunmStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.NguoiDung", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HoTen = "Quản trị viên",
                            MaVaiTro = 1,
                            MatKhauMaHoa = "$2a$11$DYzcURHQ8XI.PwtapyLdk.njsQpnssZY1f5l/lHZQ14PrFu6CUuaG",
                            NgayCapNhat = new DateTime(2026, 1, 4, 17, 59, 58, 801, DateTimeKind.Local).AddTicks(171),
                            NgayTao = new DateTime(2026, 1, 4, 17, 59, 58, 801, DateTimeKind.Local).AddTicks(145),
            ...
            modelBuilder.Entity("Backend.Models.SanPham", b =>
                {
                    ...
                    b.Property<float>("DanhGiaTrungBinh")
                        .HasColumnType("real");

                    b.Property<float>("GiaCoBan")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Backend.Models.SanPham", b =>
                {
                    ...
                    b.HasOne("Backend.Models.ThongSoKyThuat", "ThongSoKyThuat")
                        .WithOne("SanPham")
                        .HasForeignKey("Backend.Models.SanPham", "MaThongSo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
